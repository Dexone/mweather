    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      ...
      <nav class="bg-white border-gray-200 ">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl  pb-5">
          ...
          <button v-if="qCity != 'loader'" @click = update() class="flex items-center space-x-6 rtl:space-x-reverse">
            <a class="text-sm  text-gray-500  hover:underline"><svg class="w-5 h-5 text-gray-800" aria-hidden="true"
          ...
          <!-- loader -->
          <div v-if="qCity === 'loader'" class="flex items-center space-x-6 rtl:space-x-reverse">
      ...
      <div class="max-w-3xl bg-white border border-gray-200 rounded-lg shadow   mx-auto  mb-3">
        <Main />
      </div>
